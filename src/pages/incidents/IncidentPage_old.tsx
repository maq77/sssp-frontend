...
export function IncidentsPage() {
  ...
  const loadIncidents = async () => {
    setLoading(true);
    try {
      const raw = await apiClient.get<unknown>("/api/Incident/open");
                    ...
                    <div className="flex items-end justify-end gap-2">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          run(
                            async () => {
                              await apiClient.post(`/api/Incident/${incident.id}/close`);
                            },
                            "Incident closed"
                          )
                        }
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        return run(
                          async () => {
                            await apiClient.post(`/api/Incident/${incident.id}/assign/${uid}`);
                          },
                          "Incident assigned"
                        );
                      }}
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        return run(
                          async () => {
                            await apiClient.post(`/api/Incident/${incident.id}/start/${uid}`);
                          },
                          "Work started"
                        );
                      }}
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        return run(
                          async () => {
                            await apiClient.post(`/api/Incident/${incident.id}/resolve/${uid}`);
                          },
                          "Incident resolved"
                        );
                      }}
...
function CreateIncidentModal({
  ...
  const submit = async () => {
    ...
    try {
      ...
      const createdRaw = await apiClient.post<unknown>("/api/Incident", payload);
